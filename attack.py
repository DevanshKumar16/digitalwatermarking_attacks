...
class Attack:
    ...
    def cover(img: np.ndarray):
        img = img.copy()
        cv2.circle(img, (1000,500), 63, (0, 0, 255), -1)
        font = cv2.FONT_ITALIC
        cv2.putText(img, 'THIS IS AN ATTACK ', (500,500), font, 4, (255, 0, 0), 2)
        return img
...
#   cv2.imwrite(r'C:\Users\Vinay Maske\Downloads\VIT Downloads\ISM\ism code\digital-watermarking-master\digital-watermarking-master\images\attacked.jpg', img)
